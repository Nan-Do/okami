...
''' % (program_shortdesc, str(__date__))
    ...
    try:
        ...
        # The functions returns a list that contains the list of rules belonging to 
        # every stratum. For example rules_per_stratum[0] will contain the rules that
        # belong to the first stratum
        rules_per_stratum = stratifyRules(rulesTable)
        num_of_stratums = len(rules_per_stratum)
        
        # stratums will contain a list of stratums. The definition of what is a Stratum
